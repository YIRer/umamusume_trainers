...
export const BUFF_LIST = {
  buff: [
    ...
    },
    {
      ...
      result: "모든 훈련의 실패율이 감소한다. '練習ベタ' 상태가 되어도 사라지지 않음 (슈퍼 크릭 전용)",
    },
    {
      name: {
        ko: "",
      ...
      result: "팀 시리우스 카드 전용: 정열 존 상태가 된다.(일정 턴 동안 불면증, 게으름 상태 방지,모든 트레이닝이 우정 트레이닝이 된다.)",
    },
  ],
  debuff: [
    {
    ...
    },
    {
      ...
      result: "모든 훈련의 실패율이 5% 증가한다. 보건실 등으로 치료 불가능 (슈퍼크릭전용)",
    },
  ],
};
