...
export const BUFF_LIST = {
  buff: [
    ...
    },
    {
      ...
      result:
        "시조이자 인도하는 자 카드 전용: 정열 존 상태가 된다.(일정 턴 동안 불면증, 게으름 상태 방지,모든 트레이닝이 우정 트레이닝이 된다.)",
    },
    {
      name: {
        ko: "정열 존: 계속 새겨나가는 자들",
      ...
      result:
        "계속 새겨나가는 자들 카드 전용: 정열 존 상태가 된다.(일정 턴 동안 불면증, 게으름 상태 방지,모든 트레이닝이 우정 트레이닝이 된다.)",
    },
    {
      name: {
        ko: "팬과의 약속・홋카이도",
    ...
    },
    {
      ...
      result: "경기 Lv의 상승량이 높을 수록, 기초 능력과 스킬 Pt가 상승한다",
    },
    {
      name: {
        ko: "히트업: 파이트",
      ...
      result:
        "트레이닝 링크가 많을 수록, 그 트레이닝의 메인인 기초 능력이 상승한다",
    },
    {
      name: {
        ko: "히트업: 프리",
      ...
      result:
        "힌트 Lv의 발생률이 증가하여, 획득하는 스킬의 힌트 수가 최대 2개가 된다",
    },
    {
      name: {
        ko: "휴식 태세",
  ...
  debuff: [
    ...
    },
    {
      ...
      result: "레이스 출주 후 체력-5(클래식 급 11월 목표 달성으로 해제)",
    },
    {
      name: {
        ko: "얼어붙은 날개",
      ...
      result:
        "레이스 출주시 모든 스탯 -50(츠루마루 츠요시 전용. 국화상 후 해제)",
    },
  ],
};
