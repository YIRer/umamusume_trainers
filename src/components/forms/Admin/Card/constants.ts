    ...
    choices: [
      {
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『결사의 각오』또는『남김 없이』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 엘 콘도르 파사",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『텐션 오르는데!』또는『페이스 업』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 시리우스 심볼리",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『광망일섬』또는『중거리 직선◯』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 맨하탄 카페",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『내적 체험』또는『안쪽 코너 여포』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 사토노 다이아몬드",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『주목받는 댄서』또는『포지션 센스』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 오르페브르",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『노도의 추격』또는『추격』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
          ko: "목표는 탭 댄스 시티",
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『신들린 스텝』또는『경쾌한 스텝』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
      {
        description: {
        ...
        result:
          "시니어급 6월 후반에 발생하는 이벤트 변경 ※『롱샹이 점지한 아이』또는『롱샹 경기장◯』힌트 Lv 획득 ※해당 우마무스메 서포트 카드 편성으로 반드시 출현",
      },
    ],
        ...
        results: [
          {
            ...
            result:
              '"熾烈の極み"(치열함의 극치) 힌트 Lv+1 "熱狂的"(열광적) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        results: [
          {
            ...
            result:
              '"月影一閃"(월영일섬) 힌트 Lv+1 "追込直線◯"(추입 직선◯) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        results: [
          {
            condition: "에어 샤커 편성시",
            result:
              '"弧線のプロフェッサー"(호선의 프로페서) 힌트 Lv+1 "コーナー巧者◯"(코너 달인◯) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        results: [
          {
            ...
            result:
              '"迅速果断"(신속과감) 힌트 Lv+1 "位置取り押し上げ"(위치 선정 밀어붙이기) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        results: [
          {
            ...
            result:
              '"閃光"(섬광) 힌트 Lv+1 "光差す方へ"(빛이 비치는 곳으로) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        result:
          '"キラーチューン"(킬러 튠) 힌트 Lv+1 "テンポアップ"(템포 업) 힌트 Lv+1',
        results: [],
      },
    ],
    ...
    choices: [
      {
        ...
        condition: "원더 어큐트 편성시",
        result: "",
        results: [
          {
            condition: "링크 보상",
            result: '"猛追"(맹추격) 힌트 Lv+1',
          },
          {
            condition: "일반 보상",
            result: '"食らいつき"(달려들기) 힌트 Lv+1',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        result: "",
        condition: "홋코 타루마에 편성시",
        results: [
          {
            condition: "링크 보상",
            result: '"見事な砂蹴り"(훌륭한 모래차기) 힌트 Lv+1',
          },
          {
            condition: "일반 보상",
            result: '"砂蹴り"(모래차기) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        results: [
          {
            condition: "링크 보상",
            result: '"踏ませぬ影"(밟을 수 없는 그림자) 힌트 Lv+1',
          },
          {
            condition: "일반 보상",
            result: '"粘り腰"(끈질기게 버티기) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        condition: "토카이 테이오 편성시",
        result: "",
        results: [
          {
            condition: "링크 보상",
            result: '"アンストッパブル"(언스토퍼블) 힌트 Lv+1',
          },
          {
            condition: "일반 보상",
            result: '"攻めの姿勢"(공세) 힌트 Lv+1',
          },
        ],
      },
      {
        ...
        condition: "호시나 키요코 편성시",
        result: "",
        results: [
          {
            condition: "링크 보상",
            result: '"全身全霊"(전심전력) 힌트 Lv+1',
          },
          {
            condition: "일반 보상",
            result: '"末脚"(뒷심) 힌트 Lv+1',
          },
        ],
      },
    ],
    condition: "극락♪ 유코마 온천향 시나리오에서 URA 개시시",
  },
];
